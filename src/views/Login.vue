  ...
  <el-row class="login-page">
    ...
    <el-col :span="6" :offset="3" class="form">
      ...
      <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
        ...
        <!-- 注册按钮 -->
        <el-form-item>
          <el-button class="button" type="primary" auto-insert-space @click="userRegister">
            注册
          </el-button>
        </el-form-item>
      ...
      <el-form ref="form" size="large" autocomplete="off" v-else :model="loginData" :rules="rules">
        ...
        <!-- 登录按钮 -->
        <el-form-item>
          <el-button class="button" type="primary" auto-insert-space @click="userLogin">登录</el-button>
        </el-form-item>
        <el-form-item class="flex">
...
.login-page {
  ...
  .bg {
    ...
    url('@/assets/login_bg.jpg') no-repeat 30% center / cover;
